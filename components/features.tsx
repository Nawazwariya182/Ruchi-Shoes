    ...
    <section className="py-32 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="text-4xl xl:text-5xl font-light mb-6 tracking-tight">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="group text-center p-8 rounded-2xl border-[3px] border-gray-200 hover:bg-gray-50 transition-all duration-300">
              <div
